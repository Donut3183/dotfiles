...
-- d is for documentation and search ===========================================
nmap_leader("dm", "<Cmd>lua Config.search_manpages()<CR>", "Search manpages")
...
nmap_leader('em', edit_config_file('3_mini.lua'), 'Mini.nvim config')
nmap_leader('eo', edit_config_file('0_options.lua'), 'Options config')
nmap_leader('ep', edit_config_file('4_plugins.lua'), 'Plugins config')
